...
include_once '../Include/healer.inc.php';
 ...
 <h3>Cela fait un peu court, vous devriez vous présenter un peu plus en détails.</h3>
 </br>

 <form class="form-horizontal" action="reponseTest.php" method="POST">
   ...
   <div class="form-group">
     ...
     <div class="col-sm-4">
      ...
      <textarea name="Commentaire" rows="4" cols="75" placeholder="Exprimez-vous !" class="text-center"></textarea>
